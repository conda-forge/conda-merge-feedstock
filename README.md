...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-merge-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-merge-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install conda-merge
```
...
It is possible to list all of the versions of `conda-merge` available on your platform:
...
```
pixi search conda-merge --channel conda-forge
```
